  ...
  return (
    <section id="contact" ref={ref} className="py-24 px-4 relative bg-[#f0e6d2]">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          {/* 3. Apply Dance to the Header Content */}
          <motion.div {...joyboy}>
        ...
        >
          {/* 4. Apply Dance to the Form Wrapper (Converted div to motion.div) */}
          <motion.div className="relative" {...joyboy}>
