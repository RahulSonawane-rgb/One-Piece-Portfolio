  ...
  return (
    <section id="achievements" ref={ref} className="py-24 px-4 relative bg-[#f0e6d2]">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          {/* 4. Apply Dance to Sub-header (Changed div to motion.div) */}
          <motion.div 
            {...joyboy}
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="opacity-40 hover:opacity-100">
               {/* Kept Poneglyph logic as provided in prompt (even if empty in snippet) */}
               {/* Note: You imported RoadPoneglyph but the div was empty in your snippet. */}
               {/* I'm leaving it exactly as you pasted it. */}
            </div>
          </div>
        </motion.div>
